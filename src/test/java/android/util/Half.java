...
public final class Half extends Number implements Comparable<Half> {
    ...
    /**
     * Constructs a newly allocated {@code Half} object that represents the half-precision float type argument.
     *
    ...
    /**
     * Constructs a newly allocated {@code Half} object that represents the argument converted to a half-precision
     * float.
     *
     * @param value The value to be represented by the {@code Half}
     * @see #toHalf(float)
     ...
     * half-precision float value represented by the string. The string is converted to a half-precision float value as
     * if by the {@link #valueOf(String)} method.</p>
     *
    ...
    /**
     * Returns the half-precision value of this {@code Half} as a {@code short} containing the bit representation
     * described in {@link Half}.
     *
    ...
    /**
     * Returns the value of this {@code Half} as a {@code byte} after a narrowing primitive conversion.
     *
     * @return The half-precision float value represented by this object converted to type {@code byte}
     */
    @Override
    ...
    /**
     * Returns the value of this {@code Half} as a {@code short} after a narrowing primitive conversion.
     *
     * @return The half-precision float value represented by this object converted to type {@code short}
     */
    @Override
    ...
    /**
     * Returns the value of this {@code Half} as a {@code int} after a narrowing primitive conversion.
     *
     * @return The half-precision float value represented by this object converted to type {@code int}
     */
    @Override
    public int intValue() {
    ...
    /**
     * Returns the value of this {@code Half} as a {@code long} after a narrowing primitive conversion.
     *
     * @return The half-precision float value represented by this object converted to type {@code long}
     */
    @Override
    ...
    /**
     * Returns the value of this {@code Half} as a {@code float} after a widening primitive conversion.
     *
     * @return The half-precision float value represented by this object converted to type {@code float}
     */
    @Override
    ...
    /**
     * Returns the value of this {@code Half} as a {@code double} after a widening primitive conversion.
     *
     * @return The half-precision float value represented by this object converted to type {@code double}
     */
    @Override
    ...
    /**
     * Returns true if this {@code Half} value represents a Not-a-Number, false otherwise.
     *
     ...
     * {@code null} and is a {@code Half} object that represents the same half-precision value as the this object. Two
     * half-precision values are considered to be the same if and only if the method {@link #halfToIntBits(short)}
     * returns an identical {@code int} value for both.
     *
    ...
    /**
     * Returns a hash code for this {@code Half} object. The result is the integer bit representation, exactly as
     * produced by the method {@link #halfToIntBits(short)}, of the primitive half-precision float value represented by
     * this {@code Half} object.
     *
    ...
    /**
     * Returns a string representation of the specified half-precision float value. See {@link #toString(short)} for
     * more information.
     *
     ...
     * </ul>
     *
     * @param h The half-precision float value to compare to the half-precision value represented by this {@code Half}
     *          object
     * @return The value {@code 0} if {@code x} is numerically equal to {@code y}; a value less than {@code 0} if {@code
     * if {@code x} is numerically less than {@code y}; and a value greater than {@code 0} if {@code x} is numerically
     * greater than {@code y}
     */
    @Override
     ...
     * possible Not-a-Number values to a single canonical Not-a-Number value defined by {@link #NaN}.</p>
     *
     ...
     * float value according to the bit layout described in {@link Half}. The 16 most significant bits of the returned
     * value are set to 0.</p>
     *
     * @param h A half-precision float value
     * @return The bits that represent the half-precision float value
     * @see #halfToIntBits(short)
     ...
     *
     * <p>The argument is considered to be a representation of a half-precision
     * float value according to the bit layout described in {@link Half}. The 16 most significant bits of the argument
     * are ignored.</p>
     *
     ...
     * @return A value with the magnitude of the first parameter and the sign of the second parameter
     */
    ...
    /**
     * Returns the absolute value of the specified half-precision float. Special values are handled in the following
     * ways:
     * <ul>
    ...
    /**
     * Returns the unbiased exponent used in the representation of the specified  half-precision float value. if the
     * value is NaN or infinite, this* method returns {@link #MAX_EXPONENT} + 1. If the argument is 0 or a subnormal
     ...
     * representation). If the specified value is {@link #POSITIVE_INFINITY}, {@link #NEGATIVE_INFINITY}, {@link
     * #POSITIVE_ZERO}, {@link #NEGATIVE_ZERO}, NaN or any subnormal number, this method returns false.
     *
     * @param h A half-precision float value
    ...
    /**
     * Returns a {@code Half} instance representing the specified half-precision float value.
     *
     * @param h A half-precision float value
    ...
    /**
     * Returns a {@code Half} instance representing the specified string value. Calling this method is equivalent to
     * calling
     ...
     * @return a {@code Half} instance representing {@code h}
     * @throws NumberFormatException if the string does not contain a parsable half-precision float value
     */
    ...
    /**
     * Returns the half-precision float value represented by the specified string. Calling this method is equivalent to
     * calling
     * <code>toHalf(Float.parseString(h))</code>. See {@link Float#valueOf(String)}
     * for more information on the format of the string representation.
     *
    ...
    /**
     * Returns a string representation of the specified half-precision float value. Calling this method is equivalent to
     * calling
     ...
     * float value. If the value is a NaN, the result is <code>"NaN"</code>, otherwise the result follows this
     * format:</p>
     * <ul>
