 ...
 * floating point data types (also called fp16 or binary16). A half-precision float can be created from or converted to
 * single-precision floats, and is stored in a short data type.
 *
