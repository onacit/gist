...
import static p_b06c3f33ece93939e55f379ac569f468.StemsAndBranchesForMonthTest.of2020庚子04辛巳;

@Slf4j
class StemsAndBranchesForDayOfMonthTest { // 月建Test

    static 干支.日辰 of2020庚子04辛巳23丙申() {
    ...
    @Test
    void test_of2020庚子04辛巳23丙申() {
        final 干支.日辰 日辰 = of2020庚子04辛巳23丙申();
        assertThat(日辰.getGanzhi()).isNotNull().isEqualTo(干支.valueOf(天干.valueOf("丙"), 地支.valueOf("申")));
