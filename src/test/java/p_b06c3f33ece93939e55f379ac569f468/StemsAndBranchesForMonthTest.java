...
import static p_b06c3f33ece93939e55f379ac569f468.StemsAndBranchesForYearTest.of2020;

@Slf4j
class StemsAndBranchesForMonthTest { // 月建Test

    static 干支.月建 of202004() {
    ...
    void test_202004() {
        ...
        assertThat(月建.getGanzhi()).isNotNull().isEqualTo(干支.of(天干.valueOf("辛"), 地支.valueOf("巳")));
